...
const testAuthRequest = async () => {
  ...
  const details = {
    ...
    client_id: "test-client", // id generated by the client (us)
    // this challenge is a SHA256 hash (as indicated by the code_challange_method). In this case I used the value "hallo timo"
    code_challenge: "043A718774C572BD8A25ADBEB1BFCD5C0256AE11CECF9F9C3F925D0E52BEAF89E7C33990309AF837FDDEFA586EE720347D73F9D1EE2EC9B2EFECC9C67EECF2B8",
